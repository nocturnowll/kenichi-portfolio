    ...
    <section className="portfolio-section min-h-screen py-20 px-6 md:px-16 flex flex-col justify-center bg-[var(--color-bg)] relative overflow-hidden" id="the-work">
      ...
      <div className="w-full max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          {/* Right Panel: High-End Studio Visual Placeholders */}
          <motion.div 
          ...
          >
            <div className="relative w-full max-w-[420px] p-2 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl shadow-2xl transition-all duration-300 hover:rotate-0 hover:scale-[1.02]">
              <Placeholder 
              ...
              <div className="absolute top-4 right-4 flex gap-1.5 pointer-events-none">
                ...
                <span className="font-mono text-[8px] text-[var(--color-orange)] tracking-widest uppercase">Live Feed</span>
              </div>
            </div>
          </motion.div>
